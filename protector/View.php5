...
class View {
	...
	const ENGINE_TINYBUTSTRONG_3_13 = 'TinyButStrong3_13_1';
	const ENGINE_TINYBUTSTRONG_3_14 = 'TinyButStrong3_14';
	const ENGINE_TINYBUTSTRONG_3_15 = 'TinyButStrong3_15';
	...
	public function loadTemplate() {
		...
		if (!$this->templateExistsFullPath()) {
			...
			$data = [
					...
					"causado_por" => "{$call_info['file']} linha: ({$call_info['line']})",
				];
	...
	public function addJs($js = '') {
		...
		} else if ($GLOBALS['configDebug']['status'] ?? false) {
